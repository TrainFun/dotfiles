...
local peach_ee = "rgba(" .. colors.peachAlpha .. "ee)"
...
hl.env("GLFW_IM_MODULE", "ibus") -- kitty
...
hl.config({
	general = {
		...
		col = {
			active_border = peach_ee,
			inactive_border = surface0_ee,
		},
...
hl.bind("Print", hl.dsp.exec_cmd("hyprshot -zm output -m active --clipboard-only"))
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("grim >(wl-copy)"))
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("hyprshot -zm region --clipboard-only"))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("hyprshot -zm window --clipboard-only"))
